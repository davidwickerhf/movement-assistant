...
# List of config variables for Bot Conversation Handlers
CALL_DETAILS, EDIT_CALL, EDIT_ARGUMENT, ADD_TITLE, ADD_DATE, ADD_TIME, GROUP_INFO, EDIT_GROUP, ARGUMENT, INPUT_ARGUMENT, EDIT_IS_SUBGROUP, EDIT_PARENT, CATEGORY, REGION, RESTRICTION, IS_SUBGROUP, PARENT_GROUP, PURPOSE, ONBOARDING, COLOR, CANCEL_DELETE_GROUP, CONFIRM_DELETE_GROUP, DOUBLE_CONFIRM_DELETE_GROUP, FEEDBACK_TYPE, ISSUE_TYPE, INPUT_FEEDBACK, GROUP_CALLS, ALL_CALLS, CALLS_SELECTION, SELECT_CALL,LEFT, RIGHT, EDIT_CTITLE, EDIT_CDATE, EDIT_CTIME, EDIT_CDURATION, EDIT_CDESCRIPTION, EDIT_CAGENDA, EDIT_CLINK, SELECT_CEDIT_ARGUMENT, INPUT_CEDIT_ARGUMENT = range(41)
global LOCAL
...
def set_enviroment():
    ...
    if os.path.isfile('movement_assistant/secrets/env_variables.json') and os.path.getsize('movement_assistant/secrets/env_variables.json') > 0:
        with open('movement_assistant/secrets/env_variables.json', 'r') as json_file:
